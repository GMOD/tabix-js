// const zlibInflate = require('pako/lib/zlib/inflate')
// const utils = require('pako/lib/utils/common')
// const strings = require('pako/lib/utils/strings')
// const c = require('pako/lib/zlib/constants')
// const msg = require('pako/lib/zlib/messages')
// const ZStream = require('pako/lib/zlib/zstream')
// const GZheader = require('pako/lib/zlib/gzheader')
...
//     const status = zlibInflate.inflateInit2(this.strm, opt.windowBits)
...
//       status = zlibInflate.inflate(strm, c.Z_NO_FLUSH) /* no bad return value */
...
//         status = zlibInflate.inflateSetDictionary(this.strm, dict)
//       }
...
//             nextOutUtf8 = strings.utf8border(strm.output, strm.next_out)

//             tail = strm.next_out - nextOutUtf8
//             utf8str = strings.buf2string(strm.output, nextOutUtf8)

//             // move tail
//             strm.next_out = tail
//             strm.avail_out = chunkSize - tail
//             if (tail) {
//               utils.arraySet(strm.output, strm.output, nextOutUtf8, tail, 0)
//             }
